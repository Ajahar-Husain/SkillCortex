    ...
    const handlePostJob = async (e) => {
        ...
        try {
            ...
            const res = await api.post('/api/jobs', {
                ...
                // PRD §15/§31 — HR defines interview duration, difficulty, question count and coding needs.
                interviewConfig: { durationMin: 30, difficulty: 'Intermediate', numQuestions: 8 },
                codingConfig: { required: false },
            });
